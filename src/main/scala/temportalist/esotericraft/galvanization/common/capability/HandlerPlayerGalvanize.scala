...
import temportalist.esotericraft.galvanization.common.network.PacketUpdateClientModels
...
object HandlerPlayerGalvanize
	...
	def sendOtherModelsToClient(world: World, player: EntityPlayerMP): Unit = {
		...
		new PacketUpdateClientModels(nbtOfGalvanized).sendToPlayer(Galvanize, player)
	}
