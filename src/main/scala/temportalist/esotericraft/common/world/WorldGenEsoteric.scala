...
import net.minecraft.world.biome.{BiomeGenBase, BiomeGenOcean, BiomeGenRiver}
...
import temportalist.origin.api.common.utility.{NBTHelper, MathFuncs}
...
object WorldGenEsoteric extends IWorldGenerator {
	...
	override def generate(random: Random, chunkX: Int, chunkZ: Int, world: World,
		...
		*/
		...
		this.convertChunkBiome(world, pos, 0)
